...
#BENCH_LIST="alt asy bin blk cnv cnt dct dxt eig hst mrg mst mca qsr red spd scn sbq snt tfr txp vad wal"
#BENCH_LIST="asy bin dct dxt mrg mst mca qsr red spd sbq snt tfr vad wal"
BENCH_LIST="asy bin dct mca red sbq spd tfr vad wal"
...
for i in ${BENCH_LIST}; do
	for j in ${CONFIG_LIST}; do
		...
		cat run_sdk.pbs >> ./${RUN_DIR}/run_${i}.pbs
		echo " + Run ... Good luck!!"
